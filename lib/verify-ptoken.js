...
const getVerificationCommand = (_address, _network) => {
  return `npx hardhat verify --contract contracts/pToken.sol:PToken --network ${_network} ${_address}`
}
...
const verifyPTokenContract = (_address, _network) =>
  console.info('✔ Verifying pToken contract...') ||
...
module.exports = { verifyPTokenContract }
